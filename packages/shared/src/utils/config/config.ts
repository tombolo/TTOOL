...
export const domain_app_ids = {
    'smarttraderstool.com': 105383,
    'deriv.app': 105383,
    'app.deriv.com': 105383,
    'staging-app.deriv.com': 105383,
    'app.deriv.me': 105383,
    'staging-app.deriv.me': 105383,
    'app.deriv.be': 105383,
    'staging-app.deriv.be': 105383,
    'binary.com': 105383,
    'test-app.deriv.com': 105383,
    'royal-app-seven.vercel.app': 105383,
    'star-eight-ruby.vercel.app': 105383,
    'beleiver.vercel.app': 105383,
    'goon-puce.vercel.app': 105383,
};
...
export const getAppId = () => {
    ...
    if (platform && platform_app_ids[platform as keyof typeof platform_app_ids]) {
        ...
        app_id = is_bot ? 105383 : domain_app_ids[current_domain as keyof typeof domain_app_ids] || 105383;
