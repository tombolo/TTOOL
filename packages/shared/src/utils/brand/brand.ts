...
const isDomainAllowed = (domain_name: string) => {
    ...
    return /^(((.*)\.)?(localhost:8443|pages.dev|binary\.(sx|com)|deriv\.(com|me|be|dev)|goon-puce\.vercel\.app|smarttraderstool\.com|bmbtraderstool\.vercel\.app|traderstool\.site))$/.test(domain_name);
};
